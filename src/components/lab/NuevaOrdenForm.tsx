...
export default function NuevaOrdenForm({ onCreada }: { onCreada: () => void }) {
  ...
  return (
    <form ref={formRef} action={formAction} className="bg-white rounded-lg shadow-sm p-5 space-y-4">
      ...
      <div>
        <label className="block text-sm text-gray-700 mb-1">Diente (opcional)</label>
        <input
          type="text"
          name="diente"
          placeholder="Ej. 16"
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="block text-sm text-gray-700 mb-1">Tono de diente</label>
          <input
            type="text"
            name="tonoDiente"
            placeholder="Ej. A2"
